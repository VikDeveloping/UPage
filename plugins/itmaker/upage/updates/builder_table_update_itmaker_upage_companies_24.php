...
class BuilderTableUpdateItmakerUpageCompanies24 extends Migration
{
    public function up()
    {
        Schema::table('itmaker_upage_companies', function($table)
        {
            ...
            $table->decimal('coor_lat', 16, 14)->nullable()->change();
            $table->decimal('coor_long', 16, 14)->nullable()->change();
    ...
    public function down()
    {
        Schema::table('itmaker_upage_companies', function($table)
        {
            ...
            $table->decimal('coor_lat', 16, 14)->nullable(false)->change();
            $table->decimal('coor_long', 16, 14)->nullable(false)->change();
